...
document.addEventListener("DOMContentLoaded", function() {
    ...
    async function initializeMap() {
        try {
            ...
            const officeLayer = svg.append("g")
                .attr("class", "office-layer");
            ...
            offices.forEach(function(office) {
                ...
                const group = officeLayer.append("g")
                    .attr("class", "map-office-point");
                ...
                const labelX =
                    x + office.labelOffset[0];

                const labelY =
                    y + office.labelOffset[1];


                const label = officeLayer.append("g")
                    .attr(
                        "class",
                        "map-city-label-group"
                    )
                    .attr(
                        "transform",
    ...
    window.addEventListener("resize", function() {
        ...
        resizeTimer = setTimeout(function() {
            ...
            // Clear map without using innerHTML
...
function initializeFlashToasts() {
    document
        .querySelectorAll("[data-flash-toast]")
        .forEach((toast) => {
