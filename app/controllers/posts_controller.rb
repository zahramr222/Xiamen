class PostsController < ApplicationController
  ...
  def posts_index_meta_description
    case @current_type
    when "reports"
      "Explore Global Synergy's latest bitumen market reports, pricing developments, supply conditions and international trade insights."
    when "articles"
      "Read Global Synergy's latest articles covering bitumen, petroleum products, specifications, applications and international markets."
    when "news"
      "Stay updated with the latest bitumen, petroleum and international industry news from Global Synergy."
    when "applications"
      "Explore applications of bitumen and petroleum products across road construction, infrastructure and industrial sectors."
    else
      "Explore Global Synergy's latest bitumen market reports, industry articles, news and product application insights."
    end
  end
end